...
def main():
    ...
    #better solution, which enables the solver to escape a local minimum
    #When using GUIDED_LOCAL_SEARCH or other metaheuristics, you need to set a time limit for the solver
    search_parameters = pywrapcp.DefaultRoutingSearchParameters()
